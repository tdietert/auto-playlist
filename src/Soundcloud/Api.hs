...
scApiBaseURL = BaseUrl Https "api.soundcloud.com" 443 ""
scApiAuthURL = BaseUrl Https "soundcloud.com" 443 ""

type SoundcloudAPI =
       QueryParam "client_id" T.Text :> SoundcloudTrackAPI
  :<|> SoundcloudAuthAPI

type SoundcloudAuthAPI = "connect" :> Get '[JSON] ()
